...
<!-- Mirrored from education-html.themerex.net/not-existing-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jun 2018 23:42:40 GMT -->
<head>
    <meta charset="UTF-8" />
	...
	<!-- for timeline -->
	<link href="<?php echo base_url('dst/timeline/css/bootstrap.css'); ?>" rel="stylesheet">
 	<!-- Fontawesome core CSS -->
    <link href="<?php echo base_url('dst/timeline/css/font-awesome.min.css'); ?>" rel="stylesheet" />
     <!--GOOGLE FONT -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
      <!-- Timeline -->
    <link href="<?php echo base_url('dst/timeline/css/timeline.css'); ?>" rel="stylesheet" />
     <!-- custom CSS here -->

</head>

<body class="error404 body_style_wide body_filled article_style_stretch layout_excerpt top_panel_style_light top_panel_opacity_solid top_panel_above menu_right sidebar_hide">
            ...
            <div class="row ">            
                ...
                <div class="col-md-offset-2 col-md-8 col-sm-12 top-margin" >
                    <div >
                        <ul class="timeline">
                            <li class="time-label">
                                <span class="bg-orange">TIMELINE OPREC DPM KM FASILKOM
                                </span>
                                <br />
                                <br />
                            </li>
    ...
    <script type="text/javascript" src="<?php echo base_url('dst/timeline/js/bootstrap.js'); ?>"></script>
</body>
