                        ...
                        <div class="menu_user_area menu_user_right menu_user_nav_area">
                            <ul id="menu_user" class="menu_user_nav">
                                ...
                                <li class="menu_user_logout">
                                    <a href="logout" onclick="return confirm('apakah anda akan logout?')" class="icon icon-logout">Logout</a>
                                </li>
                                <?php } 
                                else{ ?>
                                <li class="menu_user_logout">
                            ...
                            <ul id="menu_main" class="menu_main_nav">
                                ...
                                <li class="menu-item menu-item-has-children"><a href="#">Informasi</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item"><a href="shortcodes.html">sertifikat</a></li>
                                    </ul>
                                </li>
                                <?php } 
                                else{ ?>
                                <li class="menu-item"><a href="#" onclick="sweet()">tryout</a></li>
                                <li class="menu-item"><a href="#" onclick="sweet()">Pembahasan</a></li>
                                <li class="menu-item menu-item-has-children"><a href="#">Informasi</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="#" onclick="sweet()">Nilai</a></li>
                                    </ul>
                                </li>
                                <?php } ?>
                            </ul>
...
<script type="text/javascript">
    function sweet() {
        swal("Upss!", "maaf anda belum login, silakan login terlebih dahulu", "warning");
    }
</script>