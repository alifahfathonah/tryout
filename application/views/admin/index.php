  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo"><b>H! Campus</b></a>
            <!--logo end-->
            <div class="top-menu">
                  	...
                  	<div class="row mtbox">
                  		<div class="col-md-2 col-sm-2 col-md-offset-1 box0">
                  			<div class="box1">
					  			...
					  			<p><?php echo "ada ".$n." siswa yang telah mendaftar!"; ?></p>
                  		</div>
					...
					<div class="row mt">
                      ...
                      <div class="custom-bar-chart">
                          ...
                          <div class="bar">
                              ...
                              <div class="value tooltips" data-original-title="40" data-toggle="tooltip" data-placement="top">3%</div>
                          </div>
                          <div class="bar ">
