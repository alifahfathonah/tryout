      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> pembahasan</h3> 
            <div class="row mt">
              <div class="col-lg-12" >
                <?php 
                $id_tes = $_GET['id_tes'];?>
                <form action="inp_soal?id_tes=<?php echo $_GET['id_tes']; ?>" method="post" enctype="multipart/form-data">
                  <div class="form-group" >
                    ...
                    <div class="col-sm-10" style="margin-bottom: 10px">
                      <textarea type="text" id="ckeditor" class="form-control ckeditor" name="soal"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Jawaban A</label>
                    <div class="col-sm-10" style="margin-bottom: 10px">
                      <textarea type="text" id="ckeditor" style="height: 200px" class="form-control ckeditor" name="A"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Jawaban B</label>
                    <div class="col-sm-10" style="margin-bottom: 10px">
                      <textarea type="text" id="ckeditor" style="height: 200px" class="form-control ckeditor" name="B"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Jawaban C</label>
                    <div class="col-sm-10" style="margin-bottom: 10px">
                      <textarea type="text" id="ckeditor" style="height: 200px" class="form-control ckeditor" name="C"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Jawaban D</label>
                    <div class="col-sm-10" style="margin-bottom: 10px">
                      <textarea type="text" id="ckeditor" style="height: 200px" class="form-control ckeditor" name="D"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Jawaban E</label>
                    <div class="col-sm-10" style="margin-bottom: 10px">
                      <textarea type="text" id="ckeditor" style="height: 200px" class="form-control ckeditor" name="E"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
