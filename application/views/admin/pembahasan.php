          ...
          <section class="wrapper site-min-height">
            ...
            <div class="row mt">
              ...
              <p>
                <?php 
                $id_tes = $_GET['id_tes'];
                foreach ($pembahasan as $key) {?>
                <form action="save_pembahasan?id_tes=<?php echo $id_tes; ?> " enctype="multipart/form-data" method="post">
                  <div class="form-group" >
                    <label class="col-sm-2 col-sm-2 control-label">Video</label>
                    <div class="col-sm-10">
                      <input type="hidden" name="id" value="<?php echo $_GET['id_sl']; ?>">
                      <input type="file" style="margin-bottom: 20px" name="video" id="gambar" value="<?PHP echo $key->link; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-12">
                      <textarea id="ckeditor" class="ckeditor" name="pembahasan" style="height: 800px;width: 100%"><?php echo $key->isi ?></textarea>
                    </div>
                  </div>
