...
THEMEREX_GLOBALS.vc_edit_mode=!1,
...
THEMEREX_GLOBALS.user_logged_in=!0,
	 
THEMEREX_GLOBALS.toc_menu="fixed",
	 
THEMEREX_GLOBALS.toc_menu_home=!1,
	 
THEMEREX_GLOBALS.toc_menu_top=!0,
	 
THEMEREX_GLOBALS.menu_fixed=!0,
	 
THEMEREX_GLOBALS.menu_relayout=960,
	 
THEMEREX_GLOBALS.menu_responsive=800,
THEMEREX_GLOBALS.menu_slider=!0,
THEMEREX_GLOBALS.demo_time=0,
THEMEREX_GLOBALS.media_elements_enabled=!0,
THEMEREX_GLOBALS.ajax_search_enabled=!0, 
THEMEREX_GLOBALS.ajax_search_min_length=3, 
THEMEREX_GLOBALS.ajax_search_delay=200, 
THEMEREX_GLOBALS.css_animation=!0, 
...
THEMEREX_GLOBALS.post_id=688}),jQuery(document).ready(function(){"use strict"; 
THEMEREX_GLOBALS.reviews_allow_user_marks=!0, 
THEMEREX_GLOBALS.reviews_max_level=100, 
THEMEREX_GLOBALS.reviews_levels="bad,poor,normal,good,great", 
THEMEREX_GLOBALS.reviews_vote="", 
...
THEMEREX_GLOBALS.post_id=636}),jQuery(document).ready(function(){ 
THEMEREX_GLOBALS.reviews_allow_user_marks=!0, 
THEMEREX_GLOBALS.reviews_max_level=100, 
THEMEREX_GLOBALS.reviews_levels="bad,poor,normal,good,great", 
THEMEREX_GLOBALS.reviews_vote="", 
...
THEMEREX_GLOBALS.post_id=26}),jQuery(document).ready(function(){"use strict"; 
THEMEREX_GLOBALS.reviews_allow_user_marks=!0, 
THEMEREX_GLOBALS.reviews_max_level=100, 
THEMEREX_GLOBALS.reviews_levels="bad,poor,normal,good,great", 
THEMEREX_GLOBALS.reviews_vote="", 
...
THEMEREX_GLOBALS.post_id=32}),jQuery(document).ready(function(){"use strict"; 
THEMEREX_GLOBALS.reviews_allow_user_marks=!0, 
THEMEREX_GLOBALS.reviews_max_level=100, 
THEMEREX_GLOBALS.reviews_levels="bad,poor,normal,good,great", 
THEMEREX_GLOBALS.reviews_vote="", 
...
THEMEREX_GLOBALS.post_id=92}),jQuery(document).ready(function(){"use strict"; 
THEMEREX_GLOBALS.ppp=6,
jQuery(".isotope_filters.isotope-courses-streampage").append('<a href="#" data-filter="*" class="isotope_filters_button active">All</a><a href="#" data-filter=".flt_55" class="isotope_filters_button">TPA</a><a href="#" data-filter=".flt_43" class="isotope_filters_button">SAINTEK</a><a href="#" data-filter=".flt_57" class="isotope_filters_button">SOSHUM</a>')}),
jQuery(document).ready(function(){"use strict"; 
...
jQuery(document).ready(function(){"use strict";
jQuery("a.zoom").prettyPhoto({hook:"data-rel",social_tools:!1,horizontal_padding:20,opacity:.8,deeplinking:!1}),
jQuery("a[data-rel^='prettyPhoto']").prettyPhoto({hook:"data-rel",social_tools:!1,horizontal_padding:20,opacity:.8,deeplinking:!1})});